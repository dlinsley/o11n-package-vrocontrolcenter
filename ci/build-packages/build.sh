...
do
  echo "Building $POM"
  mvn -f $POM -s /usr/share/maven/ref/settings-docker.xml -o versions:set -Dvco.version=$VCO_VERSION -DnewVersion=$(cat o11n-package-vrocontrolcenter-version/version)
